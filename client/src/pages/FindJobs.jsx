...
import { apiRequest, fetchJobSuggestions, updateURL } from "../utils";
...
const FindJobs = () => {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      const res = await fetchJobSuggestions("jobs/suggestions?search=jobs");
  ...
  return (
    <div>
      <Header
        title='Get a side hustle by being Hired or Hire '
        type='home'
